...
public class DoublyLinkedListStudentTest {
    ...
    public void testAddAtIndexWithInvalidIndex() {
        assertThrows(IndexOutOfBoundsException.class, () -> list.addAtIndex(-1, String.valueOf(5)));
        assertThrows(IndexOutOfBoundsException.class, () -> list.addAtIndex(1, String.valueOf(5)));
    }
    ...
    public void testRemoveLastOccurrenceWithDataNotFound() {
        list.addToFront(String.valueOf(1));
        list.addToFront(String.valueOf(2));
        list.addToFront(String.valueOf(3));
        assertThrows(NoSuchElementException.class, () -> list.removeLastOccurrence(String.valueOf(4)));
    }
}